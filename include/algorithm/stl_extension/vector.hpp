...
namespace HORIZON::ALGORITHM::STL_EXTENSION
{
	 ...
	 */
	template<class Container, typename El = typename Container::value_type>
	 ...
	 * @param container The container to search.
	 * @param element   The element to find.
	 * @param iterator  A container iterator. After calling this method, the iterator will either point to the element
	 * or the end of the container.
	 * @return          True if the element is present.
	 */
	template<class Container, typename El = typename Container::value_type, typename It = typename Container::iterator>
